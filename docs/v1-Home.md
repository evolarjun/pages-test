...
We have a newer version [AMRFinderPlus v3.0](Home.md) that has slightly changed options and significant new features. We are supporting AMRFinder version 1 until AMRFinderPlus is fully tested. If you have issues or concerns please let us know by emailing us at pd-help@ncbi.nlm.nih.gov.
...
[Standard installation instructions](v1-Installing-AMRFinder.md)  
[Bioconda installation instructions](v1-BioConda-installation.md)  
[Compile AMRFinder from source](v1-Compile-AMRFinder-from-source.md)
...
[Running AMRFinder](v1-Running-AMRFinder.md)  
[Methods](v1-Methods.md)  
[AMRFinder database](v1-AMRFinder-database.md)  
